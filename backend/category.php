  ...
  if(isset($_POST['submit']))
     {
        ...
        $sql=mysqli_query($conn,"INSERT into category(cat_name,cat_status) values('$cat_name','$cat_status')");
        ...
        <div class="main-wrapper">
            ...
            <div class="page-wrapper">
                <div class="content container-fluid">
					<div class="row">
						<div class="col-xs-4">
							<h1 class="page-title"><strong>Category:-</strong></h1>
						</div>
						<div class="col-xs-8 text-right m-b-30">
							<a href="" class="btn btn-primary rounded pull-right" data-toggle="modal" data-target="#create_project"><i class="fa fa-plus"></i> Add Category</a>
						</div>
					</div>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<select class="select" name="cat_status">
