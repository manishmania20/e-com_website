...
<!-- Mirrored from dreamguys.co.in/smarthr/blue/clients.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 13 Apr 2019 07:16:32 GMT -->
<head>
        <meta charset="utf-8">
					...
					<div class="row staff-grid-row">
						<div class="col-md-4 col-sm-4 col-xs-6 col-lg-3">
							<div class="profile-widget">
								...
								<h4 class="user-name m-t-10 m-b-0 text-ellipsis"><a href="client-profile.php">Global Technologies</a></h4>
								<h5 class="user-name m-t-10 m-b-0 text-ellipsis"><a href="client-profile.php">Barry Cuda</a></h5>
						...
						<div class="col-md-4 col-sm-4 col-xs-6 col-lg-3">
							<div class="profile-widget">
								...
								<h4 class="user-name m-t-10 m-b-0 text-ellipsis"><a href="client-profile.php">Delta Infotech</a></h4>
								<h5 class="user-name m-t-10 m-b-0 text-ellipsis"><a href="client-profile.php">Tressa Wexler</a></h5>
						...
						<div class="col-md-4 col-sm-4 col-xs-6 col-lg-3">
							<div class="profile-widget">
								...
								<h4 class="user-name m-t-10 m-b-0 text-ellipsis"><a href="client-profile.php">Cream Inc</a></h4>
								<h5 class="user-name m-t-10 m-b-0 text-ellipsis"><a href="client-profile.php">Ruby Bartlett</a></h5>
								<div class="small text-muted">CEO</div>
								<a href="chat.html" class="btn btn-default btn-sm m-t-10">Message</a>
								<a href="client-profile.php" class="btn btn-default btn-sm m-t-10">View Profile</a>
							</div>
						...
						<div class="col-md-4 col-sm-4 col-xs-6 col-lg-3">
							<div class="profile-widget">
								...
								<h4 class="user-name m-t-10 m-b-0 text-ellipsis"><a href="client-profile.php">Wellware Company</a></h4>
								<h5 class="user-name m-t-10 m-b-0 text-ellipsis"><a href="client-profile.php">Misty Tison</a></h5>
								<div class="small text-muted">CEO</div>
								<a href="chat.html" class="btn btn-default btn-sm m-t-10">Message</a>
								<a href="client-profile.php" class="btn btn-default btn-sm m-t-10">View Profile</a>
							</div>
						...
						<div class="col-md-4 col-sm-4 col-xs-6 col-lg-3">
							<div class="profile-widget">
								...
								<h4 class="user-name m-t-10 m-b-0 text-ellipsis"><a href="client-profile.php">Mustang Technologies</a></h4>
								<h5 class="user-name m-t-10 m-b-0 text-ellipsis"><a href="client-profile.php">Daniel Deacon</a></h5>
								<div class="small text-muted">CEO</div>
								<a href="chat.html" class="btn btn-default btn-sm m-t-10">Message</a>
								<a href="client-profile.php" class="btn btn-default btn-sm m-t-10">View Profile</a>
							</div>
						...
						<div class="col-md-4 col-sm-4 col-xs-6 col-lg-3">
							<div class="profile-widget">
								...
								<h4 class="user-name m-t-10 m-b-0 text-ellipsis"><a href="client-profile.php">International Software Inc</a></h4>
								<h5 class="user-name m-t-10 m-b-0 text-ellipsis"><a href="client-profile.php">Walter Weaver</a></h5>
								<div class="small text-muted">CEO</div>
								<a href="chat.html" class="btn btn-default btn-sm m-t-10">Message</a>
								<a href="client-profile.php" class="btn btn-default btn-sm m-t-10">View Profile</a>
							</div>
						...
						<div class="col-md-4 col-sm-4 col-xs-6 col-lg-3">
							<div class="profile-widget">
								...
								<h4 class="user-name m-t-10 m-b-0 text-ellipsis"><a href="client-profile.php">Mercury Software Inc</a></h4>
								<h5 class="user-name m-t-10 m-b-0 text-ellipsis"><a href="client-profile.php">Amanda Warren</a></h5>
								<div class="small text-muted">CEO</div>
								<a href="chat.html" class="btn btn-default btn-sm m-t-10">Message</a>
								<a href="client-profile.php" class="btn btn-default btn-sm m-t-10">View Profile</a>
							</div>
						...
						<div class="col-md-4 col-sm-4 col-xs-6 col-lg-3">
							<div class="profile-widget">
								...
								<h4 class="user-name m-t-10 m-b-0 text-ellipsis"><a href="client-profile.php">Carlson Tech</a></h4>
								<h5 class="user-name m-t-10 m-b-0 text-ellipsis"><a href="client-profile.php">Betty Carlson</a></h5>
								<div class="small text-muted">CEO</div>
								<a href="chat.html" class="btn btn-default btn-sm m-t-10">Message</a>
								<a href="client-profile.php" class="btn btn-default btn-sm m-t-10">View Profile</a>
							</div>
