...
<!-- Mirrored from demo.hasthemes.com/naturecircle-v2/naturecircle/shop.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 18 Jun 2019 02:59:34 GMT -->
<head>
        <meta charset="utf-8">
                        ...
                        <div class="ht-product-shop tab-content text-center">
                                    ...
                                    <div class="custom-col">
                                        <div class="single-product-item">
                                            ...
                                            <div class="product-text">
                                                ...
                                                <h5><a href="product-details.php">Juicy Grapes</a></h5>
                                                <div class="pro-price">
                                    ...
                                    <div class="custom-col">
                                        <div class="single-product-item">
                                            ...
                                            <div class="product-text">
                                                ...
                                                <h5><a href="product-details.php">Fresh Banana</a></h5>
                                                <div class="pro-price">
                                    ...
                                    <div class="custom-col">
                                        <div class="single-product-item">
                                            ...
                                            <div class="product-text">
                                                ...
                                                <h5><a href="product-details.php">Red Capsicum</a></h5>
                                                <div class="pro-price">
                                    ...
                                    <div class="custom-col">
                                        <div class="single-product-item">
                                            ...
                                            <div class="product-text">
                                                ...
                                                <h5><a href="product-details.php">Rippen Mango</a></h5>
                                                <div class="pro-price">
                                    ...
                                    <div class="custom-col">
                                        <div class="single-product-item">
                                            ...
                                            <div class="product-text">
                                                ...
                                                <h5><a href="product-details.php">Farm's Onion</a></h5>
                                                <div class="pro-price">
                                                    <span class="new-price">$40.00</span> 
                                    ...
                                    <div class="custom-col">
                                        <div class="single-product-item">
                                            ...
                                            <div class="product-text">
                                                ...
                                                <h5><a href="product-details.php">Fresh Coconut</a></h5>
                                                <div class="pro-price">
                                    ...
                                    <div class="custom-col">
                                        <div class="single-product-item">
                                            ...
                                            <div class="product-text">
                                                ...
                                                <h5><a href="product-details.php">Tangerin Juice</a></h5>
                                                <div class="pro-price">
                                    ...
                                    <div class="custom-col">
                                        <div class="single-product-item">
                                            ...
                                            <div class="product-text">
                                                ...
                                                <h5><a href="product-details.php">Pine Apple</a></h5>
                                                <div class="pro-price">
                                    ...
                                    <div class="custom-col">
                                        <div class="single-product-item">
                                            ...
                                            <div class="product-text">
                                                ...
                                                <h5><a href="product-details.php">Fresh Cucumber</a></h5>
                                                <div class="pro-price">
                                                    <span class="new-price">$86.00</span> 
                                                    <span class="old-price">$92.00</span>
                                                </div>
                            ...
                            <div class="tab-pane fade text-left" id="list" role="tabpanel">
                                <div class="single-product-item">
                                    ...
                                    <div class="product-text">
                                        <h5><a href="product-details.php">Farm Fresh Black Grape</a></h5>
                                        <div class="product-rating">
                                            <i class="fa fa-star-o color"></i>
                                            <i class="fa fa-star-o color"></i>
                                            <i class="fa fa-star-o color"></i>
                                ...
                                <div class="single-product-item">
                                    ...
                                    <div class="product-text">
                                        <h5><a href="product-details.php">Wonderfully Sweet Banana</a></h5>
                                        <div class="product-rating">
                                            <i class="fa fa-star-o color"></i>
                                            <i class="fa fa-star-o color"></i>
                                            <i class="fa fa-star-o color"></i>
                                ...
                                <div class="single-product-item">
                                    ...
                                    <div class="product-text">
                                        <h5><a href="product-details.php">Fresh Red Capcicum</a></h5>
                                        <div class="product-rating">
                                            <i class="fa fa-star-o color"></i>
                                            <i class="fa fa-star-o color"></i>
                                            <i class="fa fa-star-o color"></i>
                                ...
                                <div class="single-product-item">
                                    ...
                                    <div class="product-text">
                                        <h5><a href="product-details.php">Healthy Juicy Mango</a></h5>
                                        <div class="product-rating">
                                            <i class="fa fa-star-o color"></i>
                                            <i class="fa fa-star-o color"></i>
                                            <i class="fa fa-star-o color"></i>
                                ...
                                <div class="single-product-item">
                                    ...
                                    <div class="product-text">
                                        <h5><a href="product-details.php">Fresh Large Coconut</a></h5>
                                        <div class="product-rating">
                                            <i class="fa fa-star-o color"></i>
                                            <i class="fa fa-star-o color"></i>
                                            <i class="fa fa-star-o color"></i>
                                ...
                                <div class="single-product-item">
                                    ...
                                    <div class="product-text">
                                        <h5><a href="product-details.php">Chemical Free Fresh Juice</a></h5>
                                        <div class="product-rating">
                                            <i class="fa fa-star-o color"></i>
                                            <i class="fa fa-star-o color"></i>
                                            <i class="fa fa-star-o color"></i>
                                ...
                                <div class="single-product-item">
                                    ...
                                    <div class="product-text">
                                        <h5><a href="product-details.php">Fresh Pineapple</a></h5>
                                        <div class="product-rating">
                                            <i class="fa fa-star-o color"></i>
                                            <i class="fa fa-star-o color"></i>
                                            <i class="fa fa-star-o color"></i>
                                ...
                                <div class="single-product-item">
                                    ...
                                    <div class="product-text">
                                        <h5><a href="product-details.php">Farm's Fresh Cucumber</a></h5>
                                        <div class="product-rating">
                                            <i class="fa fa-star-o color"></i>
                                            <i class="fa fa-star-o color"></i>
                                            <i class="fa fa-star-o color"></i>
                                ...
                                <div class="newsletter-form mc_embed_signup">
                                    <form action="#" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
                                        <div id="mc_embed_signup_scroll" class="mc-form">
                                            ...
                                            s<div class="mc-news" aria-hidden="true"><input type="text" name="b_6bbb9b6f5827bd842d9640c82_05d85f18ef" tabindex="-1" value=""></div>
...
<!-- Mirrored from demo.hasthemes.com/naturecircle-v2/naturecircle/shop.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 18 Jun 2019 02:59:35 GMT -->
</php>